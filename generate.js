...
<link rel="icon" type="image/png" href="${prefix}assets/bthechange-logo.png" />
<link rel="apple-touch-icon" href="${prefix}assets/bthechange-logo.png" />
...
<header class="hdr" id="hdr">
  <div class="hdr-inner">
    ...
    <nav class="nav" id="nav">
      ...
      <a href="#" data-auth-open class="nav-signin-mobile">Sign in</a>
    ...
    <div class="hdr-cta">
      ...
      <a href="#" class="hdr-signin" id="hdr-signin-link" data-auth-open>Sign in</a>
  ...
  <section class="section muted" id="involve">
    <div class="wrap">
      ...
      <div class="programs-grid programs-grid--3 programs-grid--involve">
        <a href="${waLink('Hi, I want to partner with B The Change Welfare Society, interested in CSR / sponsorship.')}" target="_blank" rel="noopener" class="program-card program-card--withfoot" style="--card-color: var(--accent); --card-bg: var(--accent-soft); --card-tint: var(--accent-soft); background: var(--ink); color: var(--paper); border-color: var(--ink);">
          <div class="pc-num" style="color: rgba(255,255,255,.5);"><strong style="color: var(--accent);">01</strong> · PARTNER</div>
...
(async function() {
  ...
  grid.innerHTML = data.map(s => {
    ...
    return '<article class="rw-card">' + img +
      '<div class="rw-body"><div class="rw-meta"><span class="mono accent">' + (s.submitter_role || 'CONTRIBUTOR').toUpperCase() + ' · ' + esc(s.submitter_name) + '</span></div>' +
...
<main id="main">
  ...
  <section class="section dark" id="recognition">
    <div class="wrap">
      ...
      <div style="margin-top: 40px; padding-top: 28px; border-top: 1px solid rgba(255,255,255,.15);">
        <div data-reveal style="max-width: 56ch;">
          <div class="mono dim" style="margin-bottom: 12px;">TECHNOLOGY PARTNER</div>
          <h3 style="font-family: var(--font-serif); font-style: italic; font-weight: 400; font-size: clamp(28px, 4vw, 48px); margin: 0; color: var(--paper); letter-spacing: -1px;">${ORG.techPartner}</h3>
          <p style="color: rgba(255,255,255,.7); font-size: 14px; margin: 14px 0 0;">
